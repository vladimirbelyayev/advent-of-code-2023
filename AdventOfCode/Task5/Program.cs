...
var soilToFertilizerMap = new long[]
{
...
var fertilizerToWaterMap = new long[]
{
...
var lightToTemperatureMap = new long[]
{
...
var temperatureToHumidityMap = new long[]
{
...
var humidityToLocation = new long[]
{
...
//     var seedsAmount = seeds[i + 1];
//     var maxSeed = seedStart + seedsAmount;
//     seedRanges.Add((seedStart, maxSeed));
// }

// seedRanges = new List<(long seedStart, long maxSeed)>()
// {
//     (2, 5),
//     (6, 9),
//     (0,5)
...
//     var overlap = seedRanges.Where((x, index) =>
//             index != i &&
//             x.seedStart <= seedRange.maxSeed && x.maxSeed >= seedRange.seedStart)
//         .ToList();
//
//     if (overlap.Count > 0)
//     {
//         Console.WriteLine("Theres overlap!");
//     }
// }
